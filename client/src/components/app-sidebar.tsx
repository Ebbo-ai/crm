...
import { LayoutDashboard, Users, Settings, Shield, LogOut, Search, AlertCircle, Inbox, FileSpreadsheet, BarChart2, Upload } from "lucide-react";
    ...
    >
      ...
      <nav className="flex-1 py-3 px-2 space-y-0.5 overflow-y-auto">
        {[
          ...
          { title: "Monthly Import", path: "/ppr-import", icon: Upload, badge: null },
